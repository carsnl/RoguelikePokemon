...
/**
 * Charizard is one of the available Pokemon in the game. It is an NPC that has actions and
 * behaviours.
 * <p>
 * Created by:
 *
...
public class Charizard extends Pokemon {
  ...
  public Charizard() {
    ...
    backUpWeapons.addWeapon(new FireSpin());
    AffectionManager.getInstance().registerPokemon(this);
  ...
  public IntrinsicWeapon getIntrinsicWeapon() {
    return new IntrinsicWeapon(10, "slashed");
  }
  ...
  public Pokemon evolve() {
    return null; // no evolution currently
  }
}
